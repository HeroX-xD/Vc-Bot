...
from vcbot.helpers.inline import stream_markup
from vcbot.helpers.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from vcbot.helpers.filters import command, other_filters
from vcbot.helpers.queues import QUEUE, add_to_queue
...
async def generate_cover(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open("vcbot/img/heroxmusic.png")
